...
export default function DrinksByType(props) {
    useEffect(() => props.getDrinksByType(props.match.params.type), props);
    ...
    <React.Fragment>
      ...
      <main>
        ...
        <Container className={classes.cardGrid} maxWidth="md">
          ...
          <Grid container spacing={4}>
            {props.currentDrinks.map((drink, index) => (
              <Grid item key={drink.strDrink + index} xs={12} sm={6} md={4}>
      ...
      <footer className={classes.footer}>
        ...
        <Typography variant="subtitle1" align="center" color="textSecondary" component="p">
          Head on back to your current session
        </Typography>
